...
![meetily](https://repo.x-cmd.io/meetily.svg?lang=zh)
...
合计: **91,800** 行代码（覆盖前 5 种语言、共 **330** 个文件）。
...
- **上游仓库**: <https://github.com/Zackriya-Solutions/meetily>
- **官网**: <https://meetily.ai>
- **许可证**: MIT
...
- **Star**: 30,618 · **Fork**: 3,298 · **开放 issue**: 335 · **贡献者**: 21

## 累计统计

- **发布数**: 11 · **已合并 PR**: 137 · **开放 PR**: 148 · **已关闭 issue**: 101 · **开放 issue**: 234 · **提交数**: 661

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 0 | 11 | 26 | 5 | 23 | 73 |
| last60d | 2026-07-13 | 0 | 17 | 66 | 20 | 49 | 80 |
| 90d | 2026-06-13 | 0 | 19 | 99 | 23 | 81 | 82 |
| last180d | 2026-03-15 | 1 | 34 | 125 | 33 | 114 | 130 |
| 360d | 2025-09-16 | 5 | 100 | 145 | 53 | 187 | 458 |
| last720d | 2024-09-21 | 11 | 137 | 148 | 101 | 234 | 661 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/meetily.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T05:46:26Z._
